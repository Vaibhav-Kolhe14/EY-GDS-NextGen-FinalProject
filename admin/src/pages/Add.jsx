...
function Add({token}) {
    ...
    const onSubmitHandlder = async(e) => {
        ...
        try { 
            ...
            const response = await axios.post(`${import.meta.env.VITE_SERVER_URL}/api/product/add`, formData, {headers: {token}})
            ...
            if(response.data.success) {
                ...
                console.log('Error in productAdd admin jsx file')
            }
        } catch (error) {
            console.log('Error in onSubmitHandler in Add.jsx :: ', error)
            toast.error(error.message)
        }
    }

  return (
    <form onSubmit={onSubmitHandlder} className="flex flex-col w-full items-start gap-3">
      <div>
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        <div className="min-w-[180px]">
          ...
          <select onChange={(e)=>setCategory(e.target.value)} className="w-full px-3 py-2 min-w-[180px]">
        ...
        <div className="min-w-[180px]">
          ...
          <select onChange={(e)=>setSubCategory(e.target.value)} className="w-full px-3 py-2 min-w-[180px]">
